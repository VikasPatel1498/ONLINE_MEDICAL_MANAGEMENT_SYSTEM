...
def userinsert(request):
    ...
    if request.method=="POST":
        ...
        try:
            ...
            context['Error'] = "Successfully Insert Record..!!"
...
def supplier_delete_feedback(request,id):
    ...
    try:
        delete.delete()
        messages.success(request, 'Successfully Deleted Record..!')
        return redirect("supplier_fseller_paideedback")
    except:
        context['Error'] = "Not Delete Record Please Try Again..!"
        return render(request, "Supplier/feedback.html", context)

@login_required(login_url="../login1")
def supplier_paid(request,id):
    context={}
    ...
    try:
        ...
        messages.success(request, 'Successfully Paid Payment..!')
        return redirect("manage_order")
    except:
        context['Error'] = "Not Paid Payment Please Try Again..!"
